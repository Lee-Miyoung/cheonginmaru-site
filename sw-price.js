// ===== 청인마루 파트너가격(price.html) 전용 서비스워커 =====
// 이 파일은 price.html에서만 등록되고 적용 범위(scope)도 price.html로 한정되어 있어서
// 마루견적서(index.html)나 재고관리(stock.html)에는 전혀 영향을 주지 않습니다.

const CACHE_NAME = 'cm-price-cache-v1';
